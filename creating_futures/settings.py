"""
Django settings for creating_futures project.
...
SECRET_KEY = 'p*m3lsa-q4f92-r6=#30+)$s%3lyp)^7%g7n#xsy0*47_q(em+'
...
ROOT_URLCONF = 'creating_futures.urls'
...
WSGI_APPLICATION = 'creating_futures.wsgi.application'
